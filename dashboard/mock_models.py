...
EXPERT_INFO = {
    0: {
        "name": "Experto 1 — NIH ChestX-ray14",
        "arch": "ConvNeXt-Tiny",
    ...
    2: {
        "name": "Experto 3 — Osteoarthritis",
        "arch": "VGG-16 BN",
        "dataset": "Knee Osteoarthritis",
        "num_classes": 3,
        "class_names": ["KL Grade 0 (Normal)", "KL Grade 1 (Doubtful)", "KL Grade 2 (Moderate)"],
        "is_3d": False,
    },
    3: {
        "name": "Experto 4 — LUNA16",
        "arch": "R3D-18",
